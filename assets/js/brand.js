(() => {
 ...
 if(hero){const video=hero.querySelector('video');const pause=hero.querySelector('.media-pause');const dots=[...hero.querySelectorAll('.slide-dot')];let current=0,paused=reduced,timer;
